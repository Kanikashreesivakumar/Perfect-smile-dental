...
const ContactPage: NextPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsappUrl = `https://wa.me/918056781666?text=${encodedMessage}`
                ...
                <CardContent className="pt-6">
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="subject" placeholder="Appointment Request" value={formData.subject} onChange={handleChange} required />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea id="message" placeholder="How can we help you?" rows={5} value={formData.message} onChange={handleChange} required />
                    </div>
