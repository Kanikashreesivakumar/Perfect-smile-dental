  ...
  const services = [
    {
      ...
      description:
        "Our professional  stains and discoloration. The procedure is gentle on enamel while delivering dramatic results that last. We customize each treatment to your specific needs, ensuring optimal brightness without sensitivity.",
      icon: "tooth-brush",
        price: "From 800", 
