  ...
  const dentalImplantCases = [
    {
      ...
      description: "Complete restoration of a missing front tooth with natural-looking results.",
      duration: "3 months",
    ...
    },
    {
      ...
      description: "Full smile transformation with multiple implants for a confident new look.",
      duration: "6 months",
